...
export default class Game {
    ...
    render(elapsedTime) {
        ...
        for (let tile of this.mapLayout.tiles) {
            this.backBufferCtx.drawImage(tile.tileSet.image,
                tile.tileSetCoords.x * 32, tile.tileSetCoords.y * 32, 32, 32,
                tile.coords.x * 32, tile.coords.y * 32, 32, 32)
        }
